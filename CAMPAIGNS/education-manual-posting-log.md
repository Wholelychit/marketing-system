# Education Manual Posting Log

Use this file to track manual promotion for ReadEasy30 and MathEasy30.

Start week: Monday, 2026-06-01
...
- Post manually until live posting tools and accounts are approved.
- Do not use paid ads yet.
- Do not add tracking pixels yet.
- Do not promise guaranteed results.
- Use calm, no-shame language.
- Record every post so the next week can be improved.
...
| 2026-06-03 | Reddit | ESL reading discussion | No link unless allowed | `education-reddit-safe-posts.md` | Not yet |  |  |
| 2026-06-04 | Facebook | Parent and Tutor Guide | `https://readeasy30.com/parent-tutor-guide.html` | `education-facebook-parent-helper-posts.md` | Not yet |  |  |
| 2026-06-05 | Pinterest | Free Worksheet | `https://readeasy30.com/sample-reading-worksheet.html` | `education-pinterest-pin-batch.md` | Not yet |  |  |
| 2026-06-06 | YouTube Shorts | Beginner to Grade 8 readiness | `https://readeasy30.com/reading-levels-beginner-to-8th-grade.html` | `education-10-shorts-scripts.md` | Not yet |  |  |
| 2026-06-07 | Review | Weekly review | `CAMPAIGNS/education-manual-posting-log.md` | This file | Not yet |  |  |

## Daily Review Questions

At the end of each day, record:

1. Which post was easiest to create?
2. Which post got any comment, save, click, or reaction?
3. Which link should be used again?
4. Which wording felt strongest?
5. What needs to be improved before the next post?

## Week 1 Goal

The goal is not perfection.

The goal is to start public awareness, learn what people respond to, and create a repeatable promotion rhythm.

## Results Summary

Fill this in at the end of the week.
...
- Missing social account access:
- Canva asset not created:
- Link not working:
- Post rejected by platform or group:
- Need better image:
- Need better video:
- Other:
